...
public class ModItems {
    ...
    public static final RegistryObject<Item> GOLDEN_SUGAR = ITEMS.register("golden_sugar",
            () -> new Item(new Item.Properties().food(ModFoods.GOLDEN_SUGAR.build())));
    public static final RegistryObject<Item> GOLDEN_POTATO = ITEMS.register("golden_potato",
            () -> new Item(new Item.Properties().food(ModFoods.GOLDEN_POTATO.build())));
    public static final RegistryObject<Item> GOLDEN_BEETROOT = ITEMS.register("golden_beetroot",
            () -> new Item(new Item.Properties().food(ModFoods.GOLDEN_BEETROOT.build())));
    ...
    public static class ModFoods {
        ...
        public static final FoodProperties.Builder GOLDEN_SUGAR = new FoodProperties.Builder().nutrition(1).effect(() -> new MobEffectInstance(ModMobEffects.SUGAR_CRAZE.get(), 200, 0), 1f);
        public static final FoodProperties.Builder GOLDEN_SUGAR_BLOCK = new FoodProperties.Builder().nutrition(1).effect(() -> new MobEffectInstance(ModMobEffects.SUGAR_CRAZE.get(), 800, 9), 1f);
