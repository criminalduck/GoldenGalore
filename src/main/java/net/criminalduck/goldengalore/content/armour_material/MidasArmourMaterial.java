package net.criminalduck.goldengalore.content.armour_material;
...
public enum MidasArmourMaterial implements ArmorMaterial {
    ...
    MidasArmourMaterial(String name, int maxDamageFactor, int[] protectionAmounts,
